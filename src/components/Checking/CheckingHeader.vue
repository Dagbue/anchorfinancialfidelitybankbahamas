<template>
  <div class="alpha">
    <div class="content-alpha">
      ...
      <div class="content-1">
        <p class="text-1">
          OUR BEST SPENDING ACCOUNT
        </p>
        <p class="text-2">
          Checking
        </p>
        <p class="text-3">
          You’ve worked too hard for your money to be sitting idly in an average checking account. Take your funds
          above and beyond with an AFFBB Rewards Checking Account.
        </p>
