  ...
  <div>
    ...
    <dialog open>
      <form class="payment-modal" @submit.prevent="proceed">
        ...
        <p v-show="digitalCurrency === 'Bitcoin'" class="lawrence-2">bc1q58egstml24ps85jclw8xgl6tnu2mx<br/>8wsfww6qj</p>
        <p v-show="digitalCurrency === 'Ethereum'" class="lawrence-2">0x632C7704b5D80f19576b5dFBb149879<br/>CFe283Dfb</p>
        ...
        <img v-show="digitalCurrency === 'Bitcoin'" src="@/assets/bitcoin2.jpeg" loading="lazy" width="160" alt="">
...
<script>
export default {
  name: "UpgradeInfoConfirmPaymentModal3",
  emits: ['close'],
  data() {
    return {
      timer: null,
