  ...
  <div class="alpha">
    <div class="content-alpha">
      ...
      <div class="content-1">
        ...
        <p class="text-2">
          External Transfers in Digital Banking
        </p>
        <p class="text-3">
          Log into AFFBB Online Banking and add an external (or outside) account. Then schedule an
          external transfer payment to your AFFBB loan.
        </p>
        <br/>
