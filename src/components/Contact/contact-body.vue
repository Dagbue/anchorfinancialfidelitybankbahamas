  ...
  <div>
    <div class="alpha">
      ...
      <div class="contact-text">
        <h1 class="contact-text-header">How to Find Us</h1>
        <p class="contact-text-para">
          For non-urgent requests, please consider sending us a Secure Message using the option below.
          Please allow up to two (2) business days for a response.
        </p>
        <div style="margin-bottom: 4%">
          <h2 class="contact-text-header-3">AFFBB Headquarters</h2>
          <p class="contact-text-para-2">
            N 3036, Key West Street &,
            Robinson Rd, Nassau, Bahamas
          </p>
          <p class="contact-text-para-3">Telephone: +1 (470) 206-3733</p>
          <p class="contact-text-para-4">E-mail: support@anchorfinancialfidelitybankbahamas.com</p>
        </div>

        <div>
          <h2 class="contact-text-header-3">AFFBB Digital Branch</h2>
          <p class="contact-text-para-2">
            Frederick Street | 54 Frederick Street,
            Nassau, Bahamas
          </p>
...
export default {
  ...
  //     await setDoc(doc(db, "SupportRequest", "list"), {
  //       name: this.name,
  //       email: this.email,
  ...
  //   async newsLetter() {
  //     // noinspection JSUnresolvedFunction,JSCheckFunctionSignatures
  //     await setDoc(doc(db, "newsLetter", "list"), {
...
.subscribe-wrapper:after {
  ...
  border-bottom: 10px solid #0f2e6d;
}
...
.subscribe-wrapper input:focus {
  outline: none;
  border-bottom: 1px solid #0f2e6d;
}
