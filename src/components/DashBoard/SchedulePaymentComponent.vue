<template>
  <section id="InteracFundingCard" class="dashboard-body-wrapper align-center">
    <schedule-payment-modal @close="hideDialog2" v-if="dialogIsVisible2" />
    ...
    <h4>Follow the instructions below to schedule payments from your AFFBB Account </h4>
      ...
      <div class="interac-funding-steps">
        ...
        <div class="connected-banks-list">
          <a class="interac-card w-inline-block">
            <div class="setup-title-wrapper"><img src="@/assets/images/bank.svg" loading="lazy" alt="">
              <div class="setup-title">
                <div class="text-block-51">Specify the bill you want to automate, specify the amount, and set the
                  payment date to ensure timely payment.
      ...
      <div class="interac-funding-steps">
        ...
        <div class="connected-banks-list">
          <a class="interac-card w-inline-block">
            <div class="setup-title-wrapper"><img src="@/assets/images/bank.svg" loading="lazy" alt="">
              <div class="setup-title">
                <div class="text-block-51"> Arrange for your salary or other regular income to be deposited
                  directly into your account on specific dates
      ...
      <div class="interac-funding-steps">
        ...
        <div class="connected-banks-list">
          <a class="interac-card w-inline-block">
            <div class="setup-title-wrapper"><img src="@/assets/images/bank.svg" loading="lazy" alt="">
              <div class="setup-title">
                <div class="text-block-51">Schedule any necessary withdrawals or transfers, ensuring they
                  align with your payment and deposit schedules to avoid overdrafts. Click the proceed button below
                  to begin.
                  <!--                    <strong>({{userInfo.customerEmail}})</strong>-->
                </div>
              </div>
    ...
    <div class="margin-top margin-medium">
      <div class="payment-email-wrapper">
        ...
        <div class="copy-button">
          <a  class="button is-secondary copy " @click="showDialog2"  >Schedule payment</a>
        </div>
      </div>
    </div>
...
import SchedulePaymentModal from "@/components/Modals/SchedulePaymentModal.vue";
import InfoConfirmPaymentModal5 from "@/components/Modals/InfoConfirmPaymentModal5.vue";

export default {
  name: "SchedulePaymentComponent",
  components: {InfoConfirmPaymentModal5, SchedulePaymentModal},
  data() {
    return {
      currentPage: 1,
      itemsPerPage: 12,
