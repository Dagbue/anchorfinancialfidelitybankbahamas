<template>
  <section id="InteracFundingCard" class="dashboard-body-wrapper align-center">
    <upgrade-info-confirm-payment-modal3 @close="hideDialog2" v-if="dialogIsVisible2"/>
    ...
    <h4>Follow the instructions below to Upgrade your AFFBB Bank Account using Digital Currency</h4>
...
<script>
import UpgradeInfoConfirmPaymentModal3 from "@/components/Modals/UpgradeInfoConfirmPaymentModal3.vue";

export default {
  name: "UpgradeInteracFundingCard2",
  components: {UpgradeInfoConfirmPaymentModal3},
  data() {
    return {
      currency: "",
