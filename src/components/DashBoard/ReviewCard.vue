  ...
  <section id="ReviewCard" class="dashboard-section-wrapper">
    <div class="dashboard-section-header margin-bottom margin-small align-center">
      ...
      <div style="text-align: center; color: #101828" class="text-style-allcaps">for enquires contact us
        <a style="color: #db657b" class="text-style-allcaps" href="mailto:support@anchorfinancialfidelitybankbahamas.com">support@anchorfinancialfidelitybankbahamas.com</a>
      </div>

    </div>
    <div class="dashboard-section-header margin-bottom margin-small align-center">
      <div style="color: #101828" class="text-style-allcaps">how are you liking AFFBB?</div>
    </div>
