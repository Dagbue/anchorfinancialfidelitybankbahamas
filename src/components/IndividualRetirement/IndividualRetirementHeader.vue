  ...
  <div class="alpha">
    <div class="content-alpha">
      ...
      <div class="content-1">
        ...
        <p class="text-3">
          When considering your retirement, plan smart and choose an AFFBB IRA. Stop by an AFFBB Financial Center or
          call us to apply open a Roth IRA.
        </p>
      ...
      <div class="content-2">
        <img src="@/assets/Mature-male-friends-bowling-together.jpg" alt="section-1-image" class="image"/>
      </div>
...
<script>
export default {
  name: "IndividualRetirementHeader",
  methods: {
    onPostClick() {
